...
public class JKNucleotide {
	...
	public static void main(String[] args) throws Exception {
		byte[] sequence = read(new FileInputStream(System.getProperty("user.dir") + "/src/main/resources/input_25kk.txt"));
		...
		System.out.print(sb);
		System.out.println((double) (System.nanoTime() - begin) / 1_000_000_000d);
	}
}
